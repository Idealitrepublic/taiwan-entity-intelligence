...
def _demo_response():
    ...
    people = [
        ...
        ("person:周金川", "周金川", "判決記載之詐欺集團成員"),
        ("person:賴乙誠", "賴乙誠", "判決記載之詐欺集團成員"),
        ("person:朱家禾", "朱家禾", "判決記載之詐欺集團成員"),
    ]
    ...
    def do_GET(self):
        ...
        if parsed.path.startswith(prefix):
            ...
            try:
                ...
                if uniform_number==DEMO_COMPANY and query.get("demo") in ("1","true","yes"): self._json(200,_demo_response()); return
