...
def smoke_result():
    result = {"overall": "FAIL", "test_target": TEST_UNIFORM, "checks": {}, "summary": {"passed": 0, "failed": 0, "warning": 0}}
    try:
